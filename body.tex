...
$\Lambda = \frac{\beta I}{N}$. Suppose we now stratify this model to represent a scenario where each person lives in one of three different locations but may come in contact with anyone in any  location. Our model would then have three infectious proprotions ($\vec{\xi} = (I_1/N_1, I_2/N_2, I_3/N_3)$) and three susceptible compartments ($\vec{S} = (S_1, S_2, S_3)$.
