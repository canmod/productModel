...
In contrast, \term{absolute flows} are specified only in terms of the total flow. 
...
\jd{It could conceivably be useful, and presumably resulted from some mistake made somewhere along the way. I'm fine without it, though.}
...
\jd{Yes, there are repeated elements... but I'm thinking all of this, including the table, is complexification -- for every flow we need to know the from/to information, and how the flow is calculated, right? What else is any of this saying except that macpan likes to keep track of stuff in a particular way.}
...
\jd{I'm not on board with contributing twice: that messes up the ability to Markov. I'm stopping here to send email.}
