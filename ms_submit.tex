...
\newcommand{\ratevector}{\ensuremath{\vec r}}
\newcommand{\statevector}{\ensuremath{\vec x}}
\newcommand{\flowvector}{\ensuremath{\vec f}}
...
\title[Modular compartmental models]{Modular construction of compartmental epidemic models}
